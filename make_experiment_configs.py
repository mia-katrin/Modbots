...
config.save("001c016bvariable_copy.cfg")

# Case 1
config.mutation.control = 0.01
config.mutation.body = 0.24
config.save("001c024bvariable_copy.cfg")

# Case 1
config.mutation.control = 0.01
config.mutation.body = 0.32
config.save("001c032bvariable_copy.cfg")

# Case 1
config.mutation.control = 0.01
config.mutation.body = 0.48
config.save("001c048bvariable_copy.cfg")

# Case 1
config.mutation.control = 0.01
config.mutation.body = 0.64
config.save("001c064bvariable_copy.cfg")
