...
config.save("048c024b_dec_ctrnn.cfg")

# Case 1
config.mutation.control = 0.48
config.mutation.body = 0.32
config.save("048c032b_dec_ctrnn.cfg")

# Case 1
config.mutation.control = 0.01
config.mutation.body = 0.82
config.save("001c082b_dec_ctrnn.cfg")

# Case 1
config.mutation.control = 0.08
config.mutation.body = 0.82
config.save("008c082b_dec_ctrnn.cfg")

# Case 1
config.mutation.control = 0.16
config.mutation.body = 0.82
config.save("016c082b_dec_ctrnn.cfg")
